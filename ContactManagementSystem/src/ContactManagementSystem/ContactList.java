...
public class ContactList {
	...
	private Database database;
	 ...
	 public ContactList(Database database) throws SQLException {
		 ...
		 JFrame frame = new JFrame("Contact Management System");
			...
			JLabel title = new JLabel("Welcome to the application");
			...
			newContact.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					try {
						new OpenContact(new Contact(),"new",database,ContactList.this);
	 ...
	 public void refresh(ArrayList<Contact> contacts) {
			...
			for(int i=0; i<contacts.size(); i++) {
				...
				view.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						try {
							new OpenContact(c,"view", database, ContactList.this);
						} catch (SQLException e1) {
							JOptionPane.showMessageDialog(null, e1.toString());
						}
				...
				panel.add(view);
				JButton edit = GUI.button("edit", new Color(63,164, 196));
				edit.addActionListener(new ActionListener() {
					
					@Override
					public void actionPerformed(ActionEvent e) {
						try {
							new OpenContact(c,"edit",database , ContactList.this);
						} catch (SQLException e1) {
							JOptionPane.showMessageDialog(null, e1.toString());
						}
